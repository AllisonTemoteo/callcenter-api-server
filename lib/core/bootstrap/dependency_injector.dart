...
void initDi() {
  ...
  di.registerLazySingleton<IUserRepository>(() => UserRepository(di()));
  di.registerLazySingleton<LoginService>(() => LoginService(di()));
  di.registerLazySingleton<SignInService>(() => SignInService(di()));
  ...
  // api
  di.registerLazySingleton<AuthController>(() => AuthController(di(), di()));
